...
describe('Test /api/images endpoint', () => {
    it('should return 400 if no filename is provided', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should return 400 if width or height is missing', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get('/api/images?filename=image1&width=200');
        expect(response.status).toBe(400);
    }));
